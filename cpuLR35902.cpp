...
cpuLR35902::cpuLR35902()
{
	...
	lookup =
	{
		{"NOP", &a::OP_00, 4},{"LD BC,d16", &a::OP_01, 12},{"LD (BC),A", &a::OP_02, 8},{"INC BC", &a::OP_03, 8},{"INC B", &a::OP_04, 4}
		
		/*** OPCODES THAT ARE UNINITIALIZED WILL CAUSE COMPILER ISSUES ***
	
		{"DEC B", &a::OP_05, 4},{"LD B,d8", &a::OP_06, 8},{"RLCA", &a::OP_07, 4},{"LD (a16), SP", &a::OP_08, 20},{"ADD HL,BC", &a::OP_09, 8},{"LD A,(BC)", &a::OP_0A, 8},{"DEC BC", &a::OP_0B, 8},{"INC C", &a::OP_0C, 4},{"DEC C", &a::OP_0D, 4},{"LD C,d8", &a::OP_0E, 8},{"RRCA", &a::OP_0F, 4},
	...
	cb_lookup =
	{
		{"RLC B", &a::OP_CB_00, 8},{"RLC C", &a::OP_CB_01, 8},
		
		/*** OPCODES THAT ARE UNINITIALIZED WILL CAUSE COMPILER ISSUES ***
		* 
		{"RLC D", &a::OP_CB_02, 8},{"RLC E", &a::OP_CB_03, 8},{"RLC H", &a::OP_CB_04, 8},{"RLC L", &a::OP_CB_05, 8},{"RLC (HL)", &a::OP_CB_06, 16},{"RLC A", &a::OP_CB_07, 8},{"RRC B", &a::OP_CB_08, 8},{"RRC C", &a::OP_CB_09, 8},{"RRC D", &a::OP_CB_0A, 8},{"RRC E", &a::OP_CB_0B, 8},{"RRC H", &a::OP_CB_0C, 8},{"RRC L", &a::OP_CB_0D, 8},{"RRC (HL)", &a::OP_CB_0E, 16},{"RRC A", &a::OP_CB_0F, 8},
...
// |   SET HL REGISTER                                                 |
//-o------------------------------------------------------------------o
void cpuLR35902::SetRegHL(uint16_t val)
{
	hl = val;
}
...
// |   SET BC REGISTER                                                 |
//-o------------------------------------------------------------------o
void cpuLR35902::SetRegBC(uint16_t val)
{
	bc = val;
}
...
// |   SET A REGISTER                                                 |
//-o------------------------------------------------------------------o
void cpuLR35902::SetRegA(uint8_t val)
{
...
// |   SET B REGISTER                                                 |
//-o------------------------------------------------------------------o
void cpuLR35902::SetRegB(uint8_t val)
{
...
// |   SET C REGISTER                                                 |
//-o------------------------------------------------------------------o
void cpuLR35902::SetRegC(uint8_t val)
{
	uint16_t reg = 0x0000 | (val);
	bc = 0xFF00 & bc;
	bc = bc | reg;
